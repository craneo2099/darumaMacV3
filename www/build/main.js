...
var RegistroPage = (function () {
    function RegistroPage(navCtrl, navParams, ds, alertCtrl, formBuilder, keyboard, loadingCtrl, iab) {
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, app) {
        ...
        platform.ready().then(function () {
            ...
            if (_this.platform.height() > 736) {
                _this.iphoneX = true;
                console.log("iphoneXComp", _this.iphoneX);
            }
            splashScreen.hide();
        });
    }
    MyApp.prototype.goToPage = function (page) {
        ...
        if (page == __WEBPACK_IMPORTED_MODULE_3__pages_inicio_login_inicio_login__["a" /* InicioLoginPage */] || page == __WEBPACK_IMPORTED_MODULE_4__pages_darumas_gral_darumas_gral__["a" /* DarumasGralPage */]) {
            ...
            this.nav.setRoot(page, { iphoneX: this.iphoneX });
        }
        else {
            this.nav.push(page, { iphoneX: this.iphoneX });
        }
    };
    __decorate([
...
var InicioLoginPage = (function () {
    function InicioLoginPage(navCtrl, navParams, ds, formBuilder, alertCtrl, storage, datePipe, loadingCtrl, keyboard, plt, menuCtrl) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ds = ds;
        ...
        this.plt.ready().then(function (readySource) {
            console.log("altoooINI", _this.plt.height());
            if (_this.plt.height() > 736) {
                _this.iphoneX = true;
                //console.log("iphoneX",this.iphoneX);
            }
        }).catch(function (e) { return console.log('Error pltReady', e); });
    }
            ...
            if (this.loginForm.get('email').errors &&
                ...
                this.ds.doLogin(this.datosLogin)
                    ...
                    if (data["response"] == false) {
                        ...
                        _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__darumas_gral_darumas_gral__["a" /* DarumasGralPage */], { iphoneX: _this.iphoneX });
                    }
                }, function (error) {
                    console.log("errooor", error);
                    _this.loader.dismiss();
                    _this.doAlert("Error!!", "Prueba mas tarde...");
                });
            }
        }
    };
    ...
    InicioLoginPage.prototype.goToRegistro = function () {
        this.loader = this.loadingCtrl.create();
        this.loader.present();
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__registro_registro__["a" /* RegistroPage */], { iphoneX: this.iphoneX });
    };
    InicioLoginPage.prototype.goToRecuperar = function () {
        this.loader = this.loadingCtrl.create();
        this.loader.present();
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_7__recuperar_recuperar__["a" /* RecuperarPage */], { iphoneX: this.iphoneX });
    };
...
var DarumasGralPage = (function () {
    ...
    DarumasGralPage.prototype.goToScanQr = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__add_daruma_qr_add_daruma_qr__["a" /* AddDarumaQrPage */], { iphoneX: this.iphoneX });
    };
...
var AddDarumaQrPage = (function () {
                            ...
                            if (res["result"] == true) {
                                ...
                                _this.ds.isQrCodeAsignado(text, token)
                                    ...
                                    if (res2["result"] == false) {
                                        ...
                                        // quitar comentario
                                        _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_1__darumas_gral_darumas_gral__["a" /* DarumasGralPage */], { iphoneX: _this.iphoneX });
                                    }
                                }, function (error) {
    ...
    AddDarumaQrPage.prototype.goToFormDaruma = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__formulario_daruma_formulario_daruma__["a" /* FormularioDarumaPage */], { iphoneX: this.iphoneX });
    };
